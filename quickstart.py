...
# get a session!
session = InstaPy(username=os.environ['INSTA_USERNAME'], password=os.environ['INSTA_USERNAME'])#, headless_browser=True)
business_target = str(os.environ['INSTA_BUSINESS_TARGET']).split(',')
...
with smart_run(session):
    ...
    hashtags = str(os.environ['INSTA_TARGET']).split(',')
